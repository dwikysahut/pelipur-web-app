...
const routes = {
  ...
  '/dashboard/profile': localStorage.getItem('role') === '2' ? Profile : Unauthorized,
  '/dashboard/partners': localStorage.getItem('role') === '1' ? Partner : Unauthorized,
  '/dashboard/collections': localStorage.getItem('role') === '1' ? Collection : Unauthorized,
  // '/collections': Collection,
  '/collection': UserCollection,
  '/dashboard/user-history': localStorage.getItem('role') === '2' ? UserHistory : Unauthorized,
  '/dashboard/user-detail/:id': localStorage.getItem('role') === '1' ? UserDetail : Unauthorized,
  '/logout': Logout,
  '/dashboard/city-list': localStorage.getItem('role') === '1' ? CityList : Unauthorized,
  '/not-found': NotFound,
