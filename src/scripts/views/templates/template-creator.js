  ...
  for (let i = 0; i < 6; i += 1) {
    template += `
              <div class="card">
                <div class="card-item" tabindex="0">
                  <div class="img-news" tabindex="0">
                    <img class="lazyload" data-src="./images/placeholder.png">
                  </div>
                  <h4>0/0/0000 0:0</h4>
...
<<<<<<< HEAD
  ...
  createAuthTemplate,
  cityItemTemplate,
  tableCollectionsTemplate,
  dataDashboardTemplate,
  categoryItemTemplate,
  tableHistoryTemplate,
  partnerByCityItemTemplate,
  partnerByCityEmptyTemplate,
  tableCityTemplate,
  mitraListTemplate,
  skeletonNewsHomeTemplate,
